...
async function loadAnalytics() {
    try {
        ...
        document.getElementById('totalAnalyses').textContent = overview.totalAnalyses || 0;
        document.getElementById('avgScore').textContent = overview.avgScore || '-';

        if (overview.improvement !== null) {
            const improvementText = overview.improvement > 0 ? `+${overview.improvement}%` : `${overview.improvement}%`;
        ...
        document.getElementById('totalFavorites').textContent = overview.totalTracked || 0;
